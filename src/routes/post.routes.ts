...
router.get('/all/:userId', authMiddleware.authenticateUser.bind(authMiddleware), dtoValidatorMiddleware.validateRequest(PostDto.GetUserPostsReqDto), postController.getAllUserPosts.bind(postController));
...
router.put('/like/:postId', authMiddleware.authenticateUser.bind(authMiddleware), dtoValidatorMiddleware.validateRequest(PostDto.LikePostReqDto), postController.likePost.bind(postController));
router.put('/unlike/:postId', authMiddleware.authenticateUser.bind(authMiddleware), dtoValidatorMiddleware.validateRequest(PostDto.UnLikePostReqDto), postController.unLikePost.bind(postController));
